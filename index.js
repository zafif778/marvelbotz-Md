...
function title() {
console.clear()
console.log(chalk.bold.green(figlet.textSync('MarvelBotz-MD', {
font: 'Standard',
...
console.log(chalk.yellow(`\n                        ${chalk.yellow('[ Created By Marvel Official ]')}\n\n${chalk.red('Marvel-botz-Md')} : ${chalk.white('WhatsApp Bot Multi Device')}\n${chalk.red('Follow Insta Dev')} : ${chalk.white('@Aryamanik___')}\n${chalk.red('Message Me On WhatsApp')} : ${chalk.white('+62 858-9243-9939')}\n${chalk.red('Donate')} : ${chalk.white('085892439939 ( Gopay/Pulsa )')}\n`))
}
...
browser: ['Marvel-botz-Md','Safari','1.0.0'],
auth: state
})
title()
store.bind(Manik.ev)
...
Manik.sendMessage(`6285892439939@s.whatsapp.net`, {text: '*Report Bot:*'+ callerId+ 'Called Bot'})
await sleep(8000)
