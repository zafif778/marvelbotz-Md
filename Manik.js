...
global.called = false
global.Prefix = 'Multi'
global.ownerNumber = '6285892439939'
global.botName = 'MARVEL BOTZ' 
global.owner = ['6285892439939'] 
global.ownerName = 'Marvel Official'
global.packName = 'Marvel Official' 
global.author = 'Marvel Official' 
...
const buttonsDefault = [
			{ callButton: { displayText: `Call Owner!`, phoneNumber: `+6285892439939` } },
 ...
 *｢  BOT MENU  ｣*  	
 ...
 © DESIGN: Marvel Official`
 Manik.sendMessage(m.chat, { caption: anu, image: { url: "./media/menu.jpg" }, templateButtons: buttonsDefault, footer: 'MARVEL BOTZ By Marvel Official√', mentions: [m.sender] })
break 
}
...
let noshp = text
if (isNaN(parseInt(noshp))) return reply(`${command} 6285892439939`)
const sections = [
    {
...
_》Gopay : 085892439939_
_》Shopeepay : 088210930289_
_》Dana : 088210930289_
_》Qris : Chat Owner_
...
_Contoh:_
${prefix}bukti 10000|isi Saldo 6285892439939
...
let encmedia = await Manik.sendImage(`6285892439939@s.whatsapp.net`, media, `Bukti Dari: ${sender.replace("@s.whatsapp.net", "")}`, m)
let buttons = [
...
Manik.sendButtonText(`6285892439939@s.whatsapp.net`, buttons, `${bukti}`, Manik.user.name, m)
}
break
case prefix+'depoyes':
...
Note: Jika Undefined Artinya Saldo Kamu Rp ${getMonUser(sender)}_
Saldo Hanya Bisa Untuk Topup Saja, Tidak Bisa Ditarik!.`
const listMessage = {
  text: isian,
  footer: "Powered By @Marvel Official",
  title: "━━[ List Topup Marvel Botz ]━━",
  buttonText: "Klik Disini",
  sections
}
const tessgh = await Manik.sendMessage(from, listMessage)
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
    ...
    + 'FN:Marvel\n'
    + 'ORG:Marvel Official;\n'
    + 'item1.TEL;type=CELL;type=VOICE;waid=6285892439939:+62 858-9243-9939\n' 
    + 'item1.X-ABLabel:Creator Marvel Official\n'
    + 'item2.EMAIL;type=INTERNET:vmar@gmail.com\n'
    + 'item2.MAR VEL:Email\n'
...
Manik.sendMessage(m.chat, { contacts: { displayName: 'AryaManik√', contacts: [{ vcard }] } }, { quoted: m })
    ...
    + 'FN:Marvel\n'
    + 'ORG:Marvel Official;\n'
    + 'item1.TEL;type=CELL;type=VOICE;waid=6285737134572:+62 858-9243-9939\n' 
    + 'item1.X-ABLabel:Creator Marvel Official\n'
    + 'item2.EMAIL;type=INTERNET:vmar@gmail.com\n'
    + 'item2.MAR VEL:Email\n'
    + 'item3.URL:https://instagram.com/aryamanik___\n'
...
reply('Hai Kak Ini Adalah Nomor Author Saya')
            ...
            break            
             ...
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                    	...
                    	Manik.sendMessage(`6285892439939@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
